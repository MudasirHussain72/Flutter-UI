...
// To parse this JSON data, do
//
//     final mostPopularTvShowsModel = mostPopularTvShowsModelFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'most_popular_tv_shows_model.freezed.dart';
part 'most_popular_tv_shows_model.g.dart';

MostPopularTvShowsModel mostPopularTvShowsModelFromJson(String str) =>
    MostPopularTvShowsModel.fromJson(json.decode(str));

String mostPopularTvShowsModelToJson(MostPopularTvShowsModel data) =>
    json.encode(data.toJson());

@freezed
class MostPopularTvShowsModel with _$MostPopularTvShowsModel {
  const factory MostPopularTvShowsModel({
    @JsonKey(name: "total") required String total,
    @JsonKey(name: "page") required int page,
    @JsonKey(name: "pages") required int pages,
    @JsonKey(name: "tv_shows") required List<TvShow> tvShows,
  }) = _MostPopularTvShowsModel;

  factory MostPopularTvShowsModel.fromJson(Map<String, dynamic> json) =>
      _$MostPopularTvShowsModelFromJson(json);
}
...
class TvShow with _$TvShow {
  const factory TvShow({
    ...
    @JsonKey(name: "end_date") required dynamic endDate,
    @JsonKey(name: "country") required String country,
    @JsonKey(name: "network") required String network,
    @JsonKey(name: "status") required String status,
    @JsonKey(name: "image_thumbnail_path") required String imageThumbnailPath,
  }) = _TvShow;
